	    ...
	    {	
			...
			while(i==0)
			{
				...
				{	
					case '1':
							n="1";
							printf("\nYOU HAVE CHOSEN PLAN 1 ,Rs 599 /mo ");
							Sleep(3000);
							i=8;
							break;
					...
					case '2':
							n="2";
							printf("\nYOU HAVE CHOSEN PLAN 2 ,Rs 799 /mo");
							Sleep(3000);
							i=8;
							break;
					...
					case '3':
							n="3";
							printf("\nYOU HAVE CHOSEN PLAN 3 ,Rs 999 /mo");
							Sleep(3000);
							i=8;
							break;
...
int faq()
{
	...
	printf("\n1: What Is Telecom Billing?\n");
    printf("\n2: Why is the network so bad from last few days?\n");
    printf("\n3: When do you set up a tower in our area?\n");
	printf("\n4: Can we change our mobile plan?\n");
	printf("\n5: How to reset the default password?\n");
	printf("\n6: Can I know the date on which I chose my plan\n");
    printf("\n7: What is billing cycle in telecom?\n");
    ...
    switch(choice)
    {
        ...
        case '3': 
                ...
                break;
		case '4':
				printf("\nYes you can change, Login-->Change plan-->Choose your new plan\n");
				break;
		case '5':
				printf("\nTo change your password, Login-->Change password-->Enter the password you want\n");
				break;
		case '6':
				printf("\nYes you can, Login-->Profile\n");
				break;
		case '7':
